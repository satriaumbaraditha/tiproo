...
<head>
  ...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="{{ asset('bower_components/AdminLTE/plugins/bootstrap/css/bootstrap.min.css') }}">
  <!-- Font Awesome -->
...
<!-- AdminLTE App -->
<script src="bower_components/AdminLTE/bower_components/AdminLTE/dist/js/app.min.js"></script>
<!-- Sparkline -->
