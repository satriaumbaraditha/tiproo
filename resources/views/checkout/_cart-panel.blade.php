        ...
        <table class="table table-condensed">
            ...
            <tfoot>
                ...
                <tr>
                   ...
                   <td class="text-right" colspan="2"><strong>{{number_format($cart->totalPrice()+$cart->shipingFee())}}</strong></td>
                </tr>
                @else
                <tr>
                <td><strong>total</strong></td>
                <td class="text-right"colspan="2"><strong>{{number_format($cart->totalPrice())}}</strong></td>
                </tr>
                @endif
            </tfoot>
        </table>
